...
make_condor_jobs()
{
	...
	for i in $(seq 0 ${nfiles}); do 
		...
		condor_file="$(pwd)/condor_file_dir/condor_"$triggertype"_seg_"$i"_counter.job"
		condor_out_file=$(pwd)"/condor_file_dir/condor_"$triggertype"_seg_"$i"_counter.out"
		condor_err_file=$(pwd)"/condor_file_dir/condor_"$triggertype"_seg_"$i"_counter.err"
		condor_log_file=$(pwd)"/condor_file_dir/condor_"$triggertype"_seg_"$i"_counter.log"
