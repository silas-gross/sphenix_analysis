...
//		if(write_to_file) this->text_out_file->close();
 ...
 private:
	...
	TH2F* h_jet_reco;
	TH2F* h_jet_truth;
	TH1F* h_whole_truth_ER;
	TH1F* h_jet_truth_ER;
	TH1F* h_UE_truth_ER;
	TH1F* h_whole_truth_R;
	TH1F* h_jet_truth_R;
	TH1F* h_UE_truth_R;
	TH1F* h_whole_truth_eta_E;
	TH1F* h_jet_truth_eta_E;
	TH1F* h_UE_truth_eta_E;
	TH1F* h_whole_truth_eta;
	TH1F* h_jet_truth_eta;
	TH1F* h_UE_truth_eta;
	TH1F* h_whole_truth_phi_E;
	TH1F* h_jet_truth_phi_E;
	TH1F* h_UE_truth_phi_E;
	TH1F* h_whole_truth_phi;
	TH1F* h_jet_truth_phi;
	TH1F* h_UE_truth_phi;
